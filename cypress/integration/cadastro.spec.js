...
describe('Cadastro', () => {
    ...
    it('Deve realizar um cadastro', () =>{
        ...
        cy.get('#address1.form-control').should('be.visible').type(chance.address)
        ...
        cy.get('#postcode.form-control.uniform-input.text').should('be.visible').type(chance.postcode)
        cy.get('#other.form-control').should('be.visible').type(chance.character)
